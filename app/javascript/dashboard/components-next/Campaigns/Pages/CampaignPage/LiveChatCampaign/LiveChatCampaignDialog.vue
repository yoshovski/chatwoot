...
<template>
  <div
    class="w-[32rem] max-w-[calc(100vw-2rem)] z-50 min-w-0 absolute top-10 ltr:right-0 rtl:left-0 bg-n-alpha-3 backdrop-blur-[100px] p-6 rounded-2xl border border-n-weak shadow-lg flex flex-col gap-6 max-h-[85vh] overflow-y-auto"
  >
